      ...
      <div className="my-10 border-t-4 border-dashed">
        ...
        <div className='flex justify-end'>
          <div className="join mx-5 flex">
            <input className="input input-bordered border-e-0 join-item" placeholder="Buscar" />
